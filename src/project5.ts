...
const de = (a: number, b: number = 3) => a + b; //function de makes a+b result. and I set the default in "b" In this case, I should be careful not to put this default to "a" like first parameter. Because, defuault cannot have the function ignorring such parameters.
...
const spreadObject = { ...whenObject }; // in javascript, it is  Object.assign({}, whenObject);
...
const { what, ...whatever } = objectSeparate;
